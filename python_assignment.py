...
class FlightTable:
    ...
    def search_by_id(self, flightId):
...
def main():
    ...
    while True:
        ...
        if choice == 1:
            ...
            flight = flight_table.search_by_id(flightId)
            if flight:
                print(f"Flight ID: {flight.flightId}, Source: {flight.source}, Destination: {flight.destination}, Price: {flight.price}")
            else:
